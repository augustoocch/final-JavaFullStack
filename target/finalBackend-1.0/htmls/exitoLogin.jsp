...
<html>
    ...
    <head>
      ...
      <!--Bootstrap-->
        ...
        <body>
            <header>
              <nav class="navbar fixed-top navbar-expand-lg mb-5" style="background-color: black;">
                <img id="logoNav" src="${pageContext.request.contextPath}/images/logo_BA.png"/>
            ...
            <main>
                <section>
                    <br>
                        <div class="anuncioLogin">
                            <h1>Bienvenido de nuevo!</h1>
                            <p id="requestEmail"><b>Iniciaste sesion con el usuario:<b></p>
                            "<% out.print(request.getAttribute("email")); %>"
                        </div>
                        <br>
                        <div class="containerLogged">
                            <div>
                                <img class="imageEntrada" src="${pageContext.request.contextPath}/images/ciudad.jpg" alt="Card image cap">
                            </div>
                            <div class="subtEntrada">
                                <h3>Suscripcion electronica</h3>
                                <a class="link" href="${pageContext.request.contextPath}/htmls/registerPayment.jsp" target="__BLANK">
                                    <p>Suscribite al paquete informativo de la ciudad!</p>
                                </a>    
                            </div>
                        </div>      
                </section>
