        ...
        <body>
            ...
            <main>
              <div class="completeForm">
                <img class="centerLogo" src="${pageContext.request.contextPath}/images/error.png" />
                <h1 id="titleLogin">Registro invalido</h1>
                <br>
                <label>El usuario "<% out.print(request.getAttribute("emailError")); %>", ya existe.</label>
                <div>
                    <p id="volver"><b>Volver al<b><a href="${pageContext.request.contextPath}/htmls/register.jsp"> formulario de registro</a></p>
                </div>    
              </div>    
            </main>
    </body>
