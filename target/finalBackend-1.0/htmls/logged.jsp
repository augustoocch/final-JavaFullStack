...
<html>
    ...
    <head>
        ...
        <body>
            ...
            <main>
                <section>
                    <div class="tarjetaCiudad">
                        <a class="link" href="registerPayment.jsp" target="__BLANK">
                            <div class="card" >
                                <img class="card-img-top" src="../images/ticket.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title text-decoration-none">Comprar tickets</h5>
                                    <p class="card-text text-decoration-none">
                                        Realizar compra de entradas utilizando diversos medios de pago
                                    </p>
                                </div>
                            </div>
                        </a>
